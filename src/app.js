...
class Player {
  ...
  view = () => {
    ...
    div1.innerHTML = this.name;

    let div2 = document.createElement('div');
    div2.innerHTML = this.strength;
    div2.className = 'strength';

    player.append(img, div1, div2);
...
class Superwar {
  constructor(players) {
    ...
    // Type your code here
    this.players = players.map((supe, idx) => {
      let type = idx % 2 == 0 ? 'hero' : 'villain';
      return new Player(idx, supe, type);
    });
  }
